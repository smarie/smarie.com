window.onload = function() {
  ...
  createEvent("sidebar-researchgate", "Clicked ResearchGate Icon");
  ...
  // Github Post Link
  createEvent("bottom-github", "Clicked Bottom Github Follow Link");
  // ResearchGate Post Link
  createEvent("bottom-researchgate", "Clicked Bottom ResearchGate Follow Link");
}
